...
"))))
 ...
 '(package-selected-packages
   (quote
    (mu4e-jump-to-list pkgbuild-mode mu4e-maildirs-extension mu4e-query-fragments equake auth-source-pass pass password-store frames-only-mode projectile-rails which-key emamux iedit snazzy-theme sane-term wanderlust magit pacfiles-mode robe deadgrep pdf-tools pdfgrep ibuffer-projectile helm mu4e-alert undo-tree markdown-mode chruby inf-ruby auctex company-auctex haml-mode zenburn-theme yard-mode yaml-mode web-mode solarized-theme ruby-tools ruby-hash-syntax rspec-mode rainbow-delimiters psession paradox org-tree-slide org-plus-contrib nord-theme monokai-theme moe-theme lua-mode js2-mode gruvbox-theme dracula-theme doom-themes coffee-mode base16-theme ag)))
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:inherit nil :stipple nil :background "#1c1e1f" :foreground "#d6d6d4" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 125 :width normal :foundry "ADBO" :family "SauceCodePro Nerd Font Mono")))))
